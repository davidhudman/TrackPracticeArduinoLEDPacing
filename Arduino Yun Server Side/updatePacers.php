...
// holds the ipAddress that needs to be used on the network that Yun is connected to: 
// $ipAddress = "http://192.168.1.244";	// IP address for the Yun on Aaron's apt network
// $ipAddress = "http://172.20.10.7";	// IP address for Yun on my iPhone hotspot network
